...
def win(n):
    global game
    if (game[0] == n and game[1] == n and game[2] == n) or (game[3] == n and game[3] == n and game[5] == n) or (game[6] == n and game[7] == n and game[8] == n)\
...
root= Tk() 
lbl = Label(width=20, text="Игра крестики-нолики", font=('Arial', 20, 'bold'))  
